...
class CiudadModel(Model):
    def __init__(self, width, height, num_autos, list_edif, list_esta, list_glor, list_sem, num_buses,list_par, list_alto, list_entr):
        ...
        for origen_auto in list_esta:
            if contador_autos < self.num_autos:
                new_destiny = random.choice([e for e in list_entr if e != origen_auto])
